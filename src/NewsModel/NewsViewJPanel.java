 ...
 */
public class NewsViewJPanel extends javax.swing.JPanel {
    NewsHistory news;

    /**
     * Creates new form NewsViewJPanel
     */
    public NewsViewJPanel(NewsHistory news) {
        initComponents();
    ...
    private void newBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newBtnActionPerformed
        ...
        CreateNewsJPanel createNews = new CreateNewsJPanel(news);
        mainJSplitPane.setRightComponent(createNews);
    }//GEN-LAST:event_newBtnActionPerformed

    private void manageBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_manageBtnActionPerformed
        // TODO add your handling code here:
        ReadNewsJPanel readNews = new ReadNewsJPanel(news);
        mainJSplitPane.setRightComponent(readNews);
